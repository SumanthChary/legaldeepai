      ...
      <div className="min-h-screen bg-gradient-to-b from-background to-muted/20">
        ...
        <section className="container mx-auto px-4 pt-20 pb-16 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            <Button size="lg" onClick={() => setShowDownloadDialog(true)} className="gap-2">
          ...
          <div className="flex justify-center mb-16">
            <div className="relative">
              ...
              <img 
                ...
                className="relative w-48 h-48 md:w-64 md:h-64 rounded-3xl shadow-2xl"
              />
            </div>
          </div>
        </section>
        ...
        <section className="container mx-auto px-4 py-16 text-center">
          <Card className="p-8 md:p-12 bg-gradient-to-r from-primary/5 to-primary/10 border-primary/20">
