  ...
  return <section className="py-16 md:py-24 lg:py-32 bg-gradient-to-br from-slate-50/80 via-white to-blue-50/30">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        ...
        <div className="relative grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-12 lg:gap-8">
          {steps.map((step, index) => <div key={index} className="flex flex-col items-center relative">
              <InView variants={{
            hidden: {
              opacity: 0,
              y: 30
            ...
            delay: index * 0.1
              ...
              {index < steps.length - 1 && <div className="lg:hidden flex justify-center mt-8 mb-4">
