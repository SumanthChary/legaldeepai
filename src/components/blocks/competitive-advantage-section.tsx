...
export const CompetitiveAdvantageSection = () => {
  ...
  return <section className="py-24 bg-gradient-to-br from-slate-50 via-white to-blue-50/30">
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
          {advantages.map((advantage, index) => <InView key={advantage.title} variants={{
          hidden: {
            opacity: 0,
            y: 30,
            filter: "blur(4px)"
