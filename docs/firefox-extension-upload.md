...
2. **Locate the artifact**
   ...
   ```
   extension/dist/legaldeep-ai-firefox-v1.5.5.zip
   extension/legaldeep-ai-1.5.5.zip
   ```
...
3. **Upload to AMO**
   ...
   ```bash
   npm run validate:firefox-package -- extension/dist/legaldeep-ai-firefox-v1.5.5.zip
   ```
